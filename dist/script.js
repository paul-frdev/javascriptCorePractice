...
/* harmony import */ var _modules_modales__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/modales */ "./src/js/modules/modales.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modales__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (menuElem.style.display === 'none' && window.screen.availWidth <= 993) {
      ...
      menuElem.classList.add('fadeIn', 'animated');
    } else {
      menuElem.style.display = 'none';
      menuElem.classList.remove('fadeIn', 'animated');
    }
  });
...
var checkTextInputs = function checkTextInputs(selector) {
  var texInputs = document.querySelectorAll(selector);
  texInputs.forEach(function (input) {
...
var filter = function filter() {
  ...
  bntAll.addEventListener('click', function () {
    typeFilter(markAll);
  });
